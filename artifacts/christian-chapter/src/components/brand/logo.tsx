...
export function LogoMark({ className = "h-9 w-9" }: { className?: string }) {
  return (
    <svg viewBox="0 0 40 40" className={className} aria-hidden="true" focusable="false">
      <rect width="40" height="40" rx="12" fill="#1651B6" />
      <path d="M21 27c5.4-.2 8-2.2 8-4.6-2.8.2-5.6 1.6-8 4.6Z" fill="#D5E4F6" />
      ...
      <path d="M16 33h8" fill="none" stroke="#E7F0FA" strokeWidth="1.7" strokeLinecap="round" />
    </svg>
  );
}
