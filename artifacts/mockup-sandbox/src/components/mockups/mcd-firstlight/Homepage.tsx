    ...
    <main className="min-h-[100dvh] overflow-hidden bg-[#f7f3ed] text-[#3d2b47] font-['Nunito_Sans']">
      ...
      <header className="mx-auto flex max-w-[1180px] items-center justify-between px-8 py-7">
        <div className="flex items-center gap-3">
          ...
          <span className="text-[13px] font-bold tracking-[.18em] uppercase">Christian<br/>Chapter<span className="font-normal text-[#9a6f53]">.co.uk</span></span>
        </div>
      ...
      <footer className="flex items-center justify-between px-8 py-8 text-xs text-[#747b70]"><span>© 2025 Christian Chapter</span><span>Christian dating for your next chapter.</span></footer>
